...
sWorkJobResult WorkPersonalBedWarmer(sGirl& girl, bool Day0Night1, cRng& rng)
{
    ...
    EBaseImage imagetype = EBaseImage::MAID;
            ...
            else // not slave
            {
                ...
                if (headGirl->has_active_trait("Lesbian") && girl.has_active_trait("Lesbian") && effectiveness > 10)
                {
                    ...
                    if (effectiveness < 60)
                    {
                        ...
                        headGirl->lesbian(+2);
                        girl.lesbian(+2);
                        girl.AddMessage(ss.str(), EBaseImage::LESBIAN, EVENT_NOWORK);
                        return {true, 0, 0, 0};
                    }
                    else
                    {
