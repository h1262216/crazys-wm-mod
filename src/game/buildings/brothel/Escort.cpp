...
bool cEscortJob::JobProcessing(sGirl& girl, IBuilding& brothel, bool is_night) {
    ...
    int fame = 0;
    EBaseImage imagetype = EBaseImage::ESCORT;
...
EBaseImage cEscortJob::handle_sex(const std::string& prefix, int& fame, sGirl& girl, SexType type) {
    switch(type) {
    case SexType::SEX:
