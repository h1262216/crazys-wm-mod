...
public:
    ...
    cFilmSceneJob(JOBS job, const char* xml, EBaseImage event_image, SceneType scene, SexAction sex = SexAction::NONE);
...
protected:
    EBaseImage m_EventImage = EBaseImage::STUDIO_CREW;
private:
