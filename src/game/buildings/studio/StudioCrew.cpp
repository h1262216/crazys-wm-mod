...
cJobDirector::cJobDirector() : cCrewJob(JOB_DIRECTOR, "Director.xml") {
    ...
    m_EventImage = EBaseImage::DIRECTOR;
}
...
sWorkJobResult cJobStageHand::DoWork(sGirl& girl, bool is_night) {
    ...
    m_Wages = 50;
    EBaseImage imagetype = EBaseImage::STAGEHAND;
    bool filming = true;
