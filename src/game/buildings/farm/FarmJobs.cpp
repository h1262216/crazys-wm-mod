...
bool cFarmJobShepherd::JobProcessing(sGirl& girl, IBuilding& brothel, bool is_night) {
    ...
    EBaseImage imagetype = EBaseImage::HERD;
    auto msgtype = is_night ? EVENT_NIGHTSHIFT : EVENT_DAYSHIFT;
...
bool cFarmJobGetMilked::JobProcessing(sGirl& girl, IBuilding& brothel, bool is_night) {
    ...
    *Breast size*            *L*        *P*        *B*        *ml*    *oz*    *pt*            *L* = Lactation
    ...
    EBaseImage extraimage = EBaseImage::NUM_TYPES;
                           ...
                           girl.has_active_trait("Deluxe Derriere")))
    {
        ...
        else //you are good
        {
                ...
                girl.has_active_trait("Slut"))
            {
                ...
                extraimage = EBaseImage::ORAL;
            }
            else
            {
                ssextra << " and earnestly thanks";
                extraimage = EBaseImage::PROFILE;
            }
    ...
    // `J` Farm Bookmark - adding in items that can be created in the farm
    girl.AddMessage(ss.str(), EBaseImage::MILK, is_night ? EVENT_NIGHTSHIFT : EVENT_DAYSHIFT);
...
bool cFarmJobCatacombRancher::JobProcessing(sGirl& girl, IBuilding& brothel, bool is_night) {
    ...
    girl.AddMessage(ss.str(), EBaseImage::HERD, is_night ? EVENT_NIGHTSHIFT : EVENT_DAYSHIFT);
