...
sWorkJobResult WorkFreetime(sGirl& girl, bool Day0Night1, cRng& rng)
{
    ...
    girl.AddMessage(ss.str(), EBaseImage::PROFILE, Day0Night1 ? EVENT_NIGHTSHIFT : EVENT_DAYSHIFT);
    ...
    if (rng % 2)    // half of the time she will just stay home and rest
    {
                    ...
                    if (girl.libido() >= 70)
                    {
                        ...
                        if (roll_d <= 20)
                        {
                            ...
                            else if (HateLove >= 80 && girl.libido() > 99)
                            {
                                ...
                                imagetype = EBaseImage::SEX; U_Libido -= 15;
                                girl.normalsex(1);
                            }
                            else if (HateLove >= 80 && girl.libido() <= 99)
                            {
                                ...
                                imagetype = EBaseImage::MAST; U_Libido -= 15;
                            }
                            else
                            {
...
#if 1
        {
            ...
            if (girl.has_active_trait("Exhibitionist") && rng.percent(30))
            {
                ...
                imagetype = EBaseImage::NUDE; invite = true;
            }
            ...
            if (girl.has_active_trait("Nymphomaniac") && girl.libido() > 80 && !is_virgin(girl))
            {
                ...
                if (rng.percent(35))//finds someone
                {
                    if (girl.has_active_trait("Lesbian") || girl.has_active_trait("Bisexual") && rng.percent(50))//find a woman /*FIXME not sure this will work CRAZY*/
                    {
                        ...
                        imagetype = EBaseImage::LESBIAN; U_Libido -= 10;
                        girl.lesbian(1);
                    }
                    else//finds man
                    {
                        ...
                        imagetype = EBaseImage::SEX; U_Libido -= 10;
                        girl.normalsex(1);
                    }
                }
