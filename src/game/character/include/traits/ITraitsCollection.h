 ...
 */
    ...
    public:
        ...
        hDynamicTraitHandle add_dynamic_trait(sTraitID trait, bool block = false) {
            return _add_dynamic_trait(trait, block);
        }

        void add_temporary_trait(sTraitID trait, int duration, bool block = false) {
            _add_temporary_trait(trait, block, duration);
        }
